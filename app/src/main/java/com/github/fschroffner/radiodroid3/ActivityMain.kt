...
import com.github.fschroffner.radiodroid3.alarm.FragmentAlarm
import com.github.fschroffner.radiodroid3.alarm.TimePickerFragment
...
import com.github.fschroffner.radiodroid3.players.mpd.MPDServersRepository
...
class ActivityMain : AppCompatActivity(), SearchView.OnQueryTextListener,
    ...
    companion object {
        ...
        const val ACTION_SHOW_LOADING = "com.github.fschroffner.radiodroid3.show_loading"
        const val ACTION_HIDE_LOADING = "com.github.fschroffner.radiodroid3.hide_loading"
    ...
    override fun onPause() {
        ...
        if (PlayerServiceUtil.getPlayerState() == com.github.fschroffner.radiodroid3.players.PlayState.Idle) {
            PlayerServiceUtil.shutdownService()
        }
